...
const NoteBubles: React.FC<NoteBublesProps> = ({ 
  note, 
  onDone = () => {}, 
  onDelete = () => {},
  onCommentsOpen = () => {},
  ...
  // Bubble chat style with rounded corners and tail
  ...
  const openCommentsAt = (e: React.MouseEvent) => {
    e.stopPropagation();
  ...
  const toggleCommentsAt = (e: React.MouseEvent) => {
    e.stopPropagation();
    if (isCommentsOpen) {
    ...
    <div style={noteStyle}>
      ...
      <div style={actionBarStyle}>
        ...
        <div
          ...
          onMouseOut={(e) => (e.currentTarget as HTMLElement).style.backgroundColor = 'rgba(52, 152, 219, 0.2)'}
          title="Comments"
        >
